      ...
      <aside className="hidden md:flex w-56 flex-col border-r border-white/6 bg-[#0d0d0d] min-h-screen fixed top-0 left-0">
        ...
        <div className="h-14 flex items-center px-4 border-b border-white/6">
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="h-6 w-6 rounded-md bg-blue-500 flex items-center justify-center shrink-0 transition-transform group-hover:scale-105">
        ...
        <div className="p-2 border-t border-white/6">
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-zinc-600 hover:bg-white/4 hover:text-zinc-300 transition-colors w-full"
          >
