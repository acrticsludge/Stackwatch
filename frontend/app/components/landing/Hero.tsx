...
// Phase 0: normal state (2s)
// Phase 1: Supabase DB rises to 92%, bar animates (1.2s)
// Phase 2: alert toast slides in (2.8s)
// Phase 3: fade out, reset (0.5s)
function HeroDashboardDemo() {
